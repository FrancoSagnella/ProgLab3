    ...
    export class Principal
    {
        ...
        public static MostrarUsuarios()
        {
            ...
            .done(function (resultado:any){
                ...
                if(resultado.exito)
                {
                    let tabla = SegundoParcial.Principal.ArmarListaUsuarios(resultado.datos);
        ...
        public static ArmarListaUsuarios(lista:any)
        {
            ...
            else
            {
                lista.forEach((usuario:any) => {
                    ...
                    {
                        tabla+="<img style='width: 50px; height: 50px;' src='../fotos/"+usuario.foto+"'>";
                    }
                    tabla+="</td></tr>";
                });
            }
        ...
        public static MostrarAutos()
        {
            ...
            .done(function (resultado:any){
                ...
                if(resultado.exito)
                {
                    let tabla = SegundoParcial.Principal.ArmarListaAutos(resultado.datos);
                    $("#divAutos").html(tabla);
                }
