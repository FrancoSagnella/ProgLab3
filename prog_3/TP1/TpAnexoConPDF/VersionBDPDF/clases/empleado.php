...
class Empleado extends Persona
{
    ...
    public function AgregarBD()
    {
        ...
        try {
            ...
            $consulta = $AccesoDatos->RetornarConsulta("INSERT INTO empleadosPDF (nombre, apellido, dni, sexo, sueldo, turno, pathFoto) VALUES (:nombre, :apellido, :dni, :sexo, :sueldo, :turno, :pathFoto)");
    ...
    public function ModificarBD()
    {
        ...
        try {
            $AccesoDatos = AccesoDatos::TraerAccesoDatos();
            $consulta = $AccesoDatos->RetornarConsulta("UPDATE empleadosPDF SET nombre = :nombre, apellido = :apellido, dni = :dni, sexo = :sexo, sueldo = :sueldo, turno = :turno, pathFoto = :pathFoto WHERE legajo = :legajo");
    ...
    public static function EliminarBD($legajo)
    {
        ...
        try {
            $AccesoDatos = AccesoDatos::TraerAccesoDatos();
            $consulta = $AccesoDatos->RetornarConsulta("DELETE FROM empleadosPDF WHERE legajo = :legajo");
