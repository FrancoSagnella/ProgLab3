...
class AccesoDatos
{
    ...
    private function __construct()
    {
        try {
            ...
            $this->_objPDO  = new PDO('mysql:host=localhost;dbname=usuarios_test_modeloparcial;charset=utf8', 'root', '', array(PDO::ATTR_EMULATE_PREPARES => false, PDO::ATTR_ERRMODE => PDO::ERRMODE_EXCEPTION));
