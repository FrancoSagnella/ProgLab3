...
(function (PrimerParcial) {
    var Manejadora = /** @class */ (function () {
        ...
        Manejadora.AgregarProductoJSON = function () {
            ...
            var ajax = new Ajax();
            ajax.Post("./AltaProductoJSON.php", function (param) {
                alert(param);
                console.log(param);
            }, form);
        };
        Manejadora.MostrarProductosJSON = function () {
            var ajax = new Ajax();
            ajax.Get("./ListadoProductosJSON.php", function (param) {
        ...
        Manejadora.VerificarProductoJSON = function () {
            ...
            form.append("origen", origen);
            var ajax = new Ajax();
            ajax.Post("./VerificarProductoJSON.php", function (param) {
        ...
        Manejadora.MostrarInfoCookie = function () {
            ...
            var origen = document.getElementById("cboOrigen").value;
            var ajax = new Ajax();
            ajax.Get("./MostrarCookie.php", function (param) {
                param = JSON.parse(param);
                alert(param.mensaje);
                console.log(param.mensaje);
        ...
        Manejadora.AgregarProductoSinFoto = function () {
            ...
            var producto_json = new Entidades.ProductoEnvasado(nombre, origen, 0, parseInt(codigoBarra), parseInt(precio)).ToJSON();
            var form = new FormData();
            form.append("producto_json", producto_json);
            var ajax = new Ajax();
            ajax.Post("./AgregarProductoSinFoto.php", function (param) {
                param = JSON.parse(param);
                alert(param.mensaje);
                console.log(param.mensaje);
            }, form);
        ...
        Manejadora.MostrarProductosEnvasados = function () {
            var ajax = new Ajax();
            ajax.Get("./ListadoProductosEnvasados.php", function (param) {
        ...
        Manejadora.ModificarProducto = function (producto_json) {
        ...
        Manejadora.EliminarProducto = function (producto_json) {
            ...
            ajax.Post("./EliminarProductoENvasado.php", function (param) {
        ...
        Manejadora.ModificarSinFoto = function () {
            ...
            var ajax = new Ajax();
            ajax.Post("./ModificarProductoEnvasado.php", function (param) {
        ...
        Manejadora.VerificarProductoEnvasado = function () {
            ...
            //form.append("origen", origen);
            var ajax = new Ajax();
            ajax.Post("./VerificarProductoEnvasado.php", function (param) {
                document.getElementById("divInfo").innerHTML = param;
                console.log(param);
            }, form);
        };
        return Manejadora;
