...
(function (Main) {
    ...
    function MostrarGrilla() {
        ...
        ajax.Post("http://localhost/lab_3/clase04/abm_archivos_starter/administracion.php", MostrarGrillaSuccess, parametros, Fail);
    }
    ...
    function EliminarProducto(codBarra) {
        ...
        ajax.Post("http://localhost/lab_3/clase04/abm_archivos_starter/administracion.php", DeleteSuccess, parametros, Fail);
    }
