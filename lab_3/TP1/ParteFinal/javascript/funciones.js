...
function AdministrarValidaciones() {
    ...
    if (VerificarValidacionesIndex()) {
        ...
        xhr_1.open('POST', "http://localhost/prog_lab_3/lab_3/TP1/ParteFinal/backend/administracion.php", true);
        xhr_1.send(form);
...
function AdministrarValidacionesLogin() {
    ...
    if (VerificarValidacionesLogin()) {
        ...
        ajax.Post("http://localhost/prog_lab_3/lab_3/TP1/ParteFinal/backend/verificarUsuario.php", LoginSuccess, params, Fail);
    }
}
...
function AdministrarEliminar(legajo) {
    ...
    ajax.Post("http://localhost/prog_lab_3/lab_3/TP1/ParteFinal/backend/eliminar.php", DeleteSuccess, parametro, Fail);
}
function MostrarLista() {
    var parametros = "accion=mostrar";
    ajax.Post("http://localhost/prog_lab_3/lab_3/TP1/ParteFinal/backend/mostrar.php", MostrarListaSuccess, parametros, Fail);
}
